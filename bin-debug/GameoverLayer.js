...
var GameoverLayer = (function (_super) {
    ...
    function GameoverLayer() {
        ...
        this.pai_json = RES.getRes("pai_json");
        this.pai_png = RES.getRes("pai_png");
    }
    var d = __define,c=GameoverLayer,p=c.prototype;
    p.createLayer = function (opts) {
        this.oParent = opts;
        ...
        var mcFactory = new egret.MovieClipDataFactory(this.pai_json, this.pai_png);
