...
var ScrollBar = (function (_super) {
    ...
    function ScrollBar() {
        ...
        this.wpgs = 14;
        this.rg = 4;
        this.goodsSoundEnd = true;
    }
    var d = __define,c=ScrollBar,p=c.prototype;
    p.creatGloup = function (opt) {
        this.oParent = opt.oParent;
        var group = new eui.Group();
        var goods = RES.getRes("goods_json");
...
egret.registerClass(ScrollBar,'ScrollBar');
