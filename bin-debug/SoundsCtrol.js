 ...
 *
 */
var SoundsCtrol = (function (_super) {
    __extends(SoundsCtrol, _super);
    function SoundsCtrol() {
        _super.call(this);
        this.isToMusic = true;
    }
    var d = __define,c=SoundsCtrol,p=c.prototype;
    p.creatSence = function (opts) {
        this.oParent = opts;
...
egret.registerClass(SoundsCtrol,'SoundsCtrol');
