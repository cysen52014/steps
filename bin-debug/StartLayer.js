...
var StartLayer = (function (_super) {
    ...
    function StartLayer() {
        ...
        this.isko = false;
        this.sy_json = RES.getRes("sy_json");
        this.sy_png = RES.getRes("sy_png");
    }
    var d = __define,c=StartLayer,p=c.prototype;
    p.createUl = function (opt) {
        this.oParent = opt;
        ...
        var mcFactory = new egret.MovieClipDataFactory(this.sy_json, this.sy_png);
